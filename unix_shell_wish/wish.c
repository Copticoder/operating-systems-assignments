...
#include <fcntl.h>
#define SIZE 64
// A unix like shell that can execute commands and builtins like cd, exit, path etc. It can also redirect output to a file. It can also execute multiple commands separated by a pipe. It can also execute multiple commands separated by a pipe and redirect output to a file.
